...
if "privacy_parameters" not in st.session_state:
    st.session_state["privacy_parameters"] = {"storage_consent": st.session_state.is_authenticated, "ad_consent": False, "image_gen": False, "targeted_ads_consent": False, "allowed_third_party_data_vendors" : dict([(vendor, False) for vendor in st.session_state["third_party_data_vendors"]])}
